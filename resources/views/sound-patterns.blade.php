        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-sec ps-md-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="lesson-heading">Sound Patterns <span>(Level 10-15)</span> <img class="image-icon" src="images/abc.png">
                        </h1>
                        <p class="letters-text">
                            You'll find here more than 150 pages of fun printable
                            exercises that help children develop word recognition,
