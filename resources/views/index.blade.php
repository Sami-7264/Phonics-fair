        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-sec ps-md-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="lesson-heading">ABC's <span>(Level 1-4)</span> <img class="image-icon" src="images/abc.png">
                        </h1>
                        <p class="letters-text">
                            Here you will find over 100 printable phonics worksheets for children
                            studying how to read and write for the first time. Lots of fun exercises
                            help build your child's phonemic awareness.</p>
                    </div>
